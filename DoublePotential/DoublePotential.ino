...
void loop() 
{
    int xDegrees = map(getDegree(xROTARY_ANGLE_SENSOR),0,FULL_ANGLE,-FULL_ANGLE/2,FULL_ANGLE/2);
    int yDegrees = map(getDegree(yROTARY_ANGLE_SENSOR),0,FULL_ANGLE,-FULL_ANGLE/2,FULL_ANGLE/2);
